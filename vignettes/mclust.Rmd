...
This document gives a quick tour of `mclust` functionalities. It was written in R Markdown, using the `knitr` package for production. 
It corresponds to `mclust` version `r packageVersion("mclust")`.
See the help pages for further details and references provided by `citation("mclust")`.
